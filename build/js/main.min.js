...
window.addEventListener('DOMContentLoaded', function () {
  var fileInputs = document.querySelectorAll('.form__file input[type="file"]');
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('change', function () {
      var label = this.closest('.form__file');
  ...
  var regItems = document.querySelectorAll('.registration__item');
  var count = regItems.length * 7;
  var regList = document.querySelector('.registration__list');
